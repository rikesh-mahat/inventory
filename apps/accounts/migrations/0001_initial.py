    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=15, unique=True, validators=[apps.accounts.utils.validate_mobile_number])),
                ('email', models.EmailField(max_length=254, unique=True, validators=[apps.accounts.utils.valid_emails])),
